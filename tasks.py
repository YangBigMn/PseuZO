...
class CopaDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        train_examples = MsDataset.load("super_glue",subset_name="copa",split="train")
        valid_examples = MsDataset.load('super_glue',subset_name="copa",split="validation")
...
class MultiRCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="multirc")
        train_set = d["train"]
        valid_set = d["validation"]
...
class CBDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="cb")
        train_set = d["train"]
        valid_set = d["validation"]
...
class WICDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="wic")
        train_set = d["train"]
        valid_set = d["validation"]
...
class WSCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="wsc")
        train_set = d["train"]
        valid_set = d["validation"]
...
class ReCoRDDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="record")
        train_set = d["train"]
        valid_set = d["validation"]
...
class RTEDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        d = MsDataset.load("super_glue",subset_name="rte")
        train_set = d["train"]
        valid_set = d["validation"]
